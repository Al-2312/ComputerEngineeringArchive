...
//VERSION: 2.0
//Date: 11/22/2024
// Updated and Added Simulation Constructor to hold array,sizearray, binsize
//for HistoGram jframe class and added getdata,getNumBins,getnumSize
package montecarlo;
...
public class Simulation {
	...
	int numSize;
	///
	public Simulation(ArrayList<Double> data, int numBins,int numsize) {
        this.data = data;
        this.numBins = numBins;
        this.numSize= numsize;
        generateNormalRandomNumbers(this.data,this.numSize);
    }
	...
	public double getMin(ArrayList<Double> Array) {
		...
		public double getRange(ArrayList<Double> Array) {
			return (getMax(Array)-getMin(Array))/getNumBins();
		}//end get range
